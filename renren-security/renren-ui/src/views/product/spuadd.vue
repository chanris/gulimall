				...
				<el-card class="box-card" style="width:80%;margin:20px auto">
					<el-form ref="spuBaseForm" :model="spu" label-width="120px" :rules="spuBaseInfoRules">
						...
						<el-form-item label="商品介绍" prop="decript">
							<multi-upload v-model:resource-url="spu.decript"></multi-upload>
						</el-form-item>
...
export default {
	...
	methods: {
		...
		getMemberLevels() {
			...
			productService.get("member/memberlevel/page", { limit: 500, page: 1 })
				.then(({ data }) => {
		...
		getShowSaleAttr() {
			...
			if (!this.dataResp.steped[1]) {
				...
				// 查询销售属性
				productService.get('/product/attr/page', { catelogId: this.spu.catalogId, attrType: 0 })
					.then(({ data }) => {
