<template>
	<div class="mod-product__brand">
		<el-form :inline="true" :model="state.dataForm" @keyup.enter="state.getDataList()">
			...
			<el-form-item>
				<el-button v-if="state.hasPermission('product:brand:delete')" type="danger"
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border
			...
			<el-table-column label="操作" fixed="right" header-align="center" align="center" width="200">
				<template v-slot="scope">
					...
					<el-button v-if="state.hasPermission('product:brand:delete')" type="primary" link
						@click="handleCategoryBrandRelation(scope.row.brandId)">关联分类</el-button>
		...
		<el-pagination :current-page="state.page" :page-sizes="[5, 10, 20, 50, 100]" :page-size="state.limit"
